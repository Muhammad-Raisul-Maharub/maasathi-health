...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "settings.themeDesc": "Toggle light / dark mode",
    "settings.language": "Language",
    "settings.languageDesc": "Switch between English and Bangla",
    "settings.help": "Help & guidance",
    "settings.helpDesc": "How to use MaaSathi safely",
    "settings.signOut": "Sign Out",
    "settings.signOutDesc": "Log out of your account on this device",
    "install.title": "Install MaaSathi AI",
    "install.description": "Add to home screen for offline access and better performance.",
    "install.button": "Install App",
    "history.title": "My Health History",
    "history.empty": "No assessments yet",
    "history.unsynced": "Unsynced",
    "history.synced": "Synced",
    "history.exported": "PDF Exported",
    "history.exportedDesc": "Medical report has been downloaded.",
    ...
    "history.syncedCount": "assessments synced to cloud.",
  ...
  bn: {
    ...
    "nav.home": "হোম",
    "nav.assess": "মূল্যায়ন",
    "nav.history": "ইতিহাস",
    "nav.analytics": "বিশ্লেষণ",
    "nav.settings": "সেটিংস",
    "settings.title": "সেটিংস",
    "settings.theme": "থিম",
    "settings.themeDesc": "লাইট / ডার্ক মোড পরিবর্তন করুন",
    "settings.language": "ভাষা",
    "settings.languageDesc": "ইংরেজি ও বাংলার মধ্যে পরিবর্তন করুন",
    "settings.help": "সাহায্য ও গাইড",
    "settings.helpDesc": "MaaSathi কিভাবে ব্যবহার করবেন",
    "settings.signOut": "সাইন আউট",
    "settings.signOutDesc": "এই ডিভাইস থেকে লগ আউট করুন",
    "install.title": "MaaSathi AI ইনস্টল করুন",
    "install.description": "অফলাইন অ্যাক্সেস এবং ভালো পারফরম্যান্সের জন্য হোম স্ক্রিনে যোগ করুন।",
    "install.button": "অ্যাপ ইনস্টল করুন",
    "history.title": "আমার স্বাস্থ্য ইতিহাস",
    "history.empty": "এখনো কোনো মূল্যায়ন নেই",
    "history.unsynced": "অসিঙ্কড",
    "history.synced": "সিঙ্কড",
    "history.exported": "PDF ডাউনলোড হয়েছে",
    "history.exportedDesc": "মেডিকেল রিপোর্ট ডাউনলোড করা হয়েছে।",
    ...
    "history.syncedCount": "টি মূল্যায়ন ক্লাউডে সিঙ্ক হয়েছে।",
