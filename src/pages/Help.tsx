  ...
  return (
    <div className="bg-background min-h-screen pb-20">
      <div className="max-w-md mx-auto w-full px-4 py-3 space-y-3 animate-fade-in">
        ...
        <Card id="assessment" className="p-4 space-y-2.5 animate-fade-in">
        ...
        <Card className="p-4 space-y-2.5 animate-fade-in">
          <h2 className="text-base font-bold text-foreground">
        ...
        <Card id="result" className="p-4 space-y-2.5 animate-fade-in">
          <h2 className="text-base font-bold text-foreground">
